        ...
        <article className={styles.post}>
            <header>
                <div className={styles.author}>
                    <img className={styles.avatar} src= "https://pps.whatsapp.net/v/t61.24694-24/244742221_489976699420715_4215383149013828570_n.jpg?ccb=11-4&oh=b13a2216e4208f74e9d3f6212e88c421&oe=62D6F2C2" />
